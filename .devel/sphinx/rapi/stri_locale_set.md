...
```
## You are now working with stringi_1.8.8 (pt_BR.UTF-8; ICU4C 74.1 [bundle]; Unicode 15.1)
```
...
```
## You are now working with stringi_1.8.8 (en_AU.UTF-8; ICU4C 74.1 [bundle]; Unicode 15.1)
```
