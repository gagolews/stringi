...
#' Handle with care.
#' 
#' Indices are 1-based, i.e. index 1 denotes the first character
...
#' 
#' 
#' For \code{stri_sub}, in case of out-of-bound indices, they are silently 
#' corrected. If \code{from} > \code{to}, then an empty string is returned.
#' 
#' For \code{stri_sub<-}, ``strange'' configurations of indices work as
...
#' returns a character vector with given substrings substituted
#' with \code{value}.
#' 
#' @examples
