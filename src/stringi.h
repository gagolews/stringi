...
SEXP stri_split_regex(SEXP str, SEXP pattern, SEXP n);                     // ...TO DO...
//SEXP stri_extract_first_regex(SEXP str, SEXP pattern, SEXP opts_regex);    // ...TO DO...
//SEXP stri_extract_last_regex(SEXP str, SEXP pattern, SEXP opts_regex);     // ...TO DO...
//SEXP stri_extract_all_regex(SEXP str, SEXP pattern, SEXP opts_regex);      // ...TO DO...
