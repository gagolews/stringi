...
static const R_CallMethodDef cCallMethods[] = {
   ...
   {"stri_justify",                    (DL_FUNC)&stri_justify,                    2},
   ...
   {"stri_sub_op",               		(DL_FUNC)&stri_sub_op, 		         	    4},
