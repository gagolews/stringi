...
#ifndef NDEBUG
   if (!STRI__UCHAR_IS_GC_MASK(id)) error("DEBUG: !STRI__UCHAR_IS_GC_MASK");
#endif
...
#define STRI_BINARYPROPERTY_CREATE(x, y) \
   if (!strcmp(name, x)) id = y;

        STRI_BINARYPROPERTY_CREATE("ALPHABETIC", UCHAR_ALPHABETIC)
   else STRI_BINARYPROPERTY_CREATE("ASCII_HEX_DIGIT", UCHAR_ASCII_HEX_DIGIT)
   else STRI_BINARYPROPERTY_CREATE("BIDI_CONTROL", UCHAR_BIDI_CONTROL)
   else STRI_BINARYPROPERTY_CREATE("BIDI_MIRRORED", UCHAR_BIDI_MIRRORED)
   else STRI_BINARYPROPERTY_CREATE("DASH", UCHAR_DASH)
   else STRI_BINARYPROPERTY_CREATE("DEFAULT_IGNORABLE_CODE_POINT", UCHAR_DEFAULT_IGNORABLE_CODE_POINT)
   else STRI_BINARYPROPERTY_CREATE("DEPRECATED", UCHAR_DEPRECATED)
   else STRI_BINARYPROPERTY_CREATE("DIACRITIC", UCHAR_DIACRITIC)
   else STRI_BINARYPROPERTY_CREATE("EXTENDER", UCHAR_EXTENDER)
   else STRI_BINARYPROPERTY_CREATE("FULL_COMPOSITION_EXCLUSION", UCHAR_FULL_COMPOSITION_EXCLUSION)
   else STRI_BINARYPROPERTY_CREATE("GRAPHEME_BASE", UCHAR_GRAPHEME_BASE)
   else STRI_BINARYPROPERTY_CREATE("GRAPHEME_EXTEND", UCHAR_GRAPHEME_EXTEND)
   else STRI_BINARYPROPERTY_CREATE("GRAPHEME_LINK", UCHAR_GRAPHEME_LINK)
   else STRI_BINARYPROPERTY_CREATE("HEX_DIGIT", UCHAR_HEX_DIGIT)
   else STRI_BINARYPROPERTY_CREATE("HYPHEN", UCHAR_HYPHEN)
   else STRI_BINARYPROPERTY_CREATE("ID_CONTINUE", UCHAR_ID_CONTINUE)
   else STRI_BINARYPROPERTY_CREATE("ID_START", UCHAR_ID_START)
   else STRI_BINARYPROPERTY_CREATE("IDEOGRAPHIC", UCHAR_IDEOGRAPHIC)
   else STRI_BINARYPROPERTY_CREATE("IDS_BINARY_OPERATOR", UCHAR_IDS_BINARY_OPERATOR)
   else STRI_BINARYPROPERTY_CREATE("IDS_TRINARY_OPERATOR", UCHAR_IDS_TRINARY_OPERATOR)
   else STRI_BINARYPROPERTY_CREATE("JOIN_CONTROL", UCHAR_JOIN_CONTROL)
   else STRI_BINARYPROPERTY_CREATE("LOGICAL_ORDER_EXCEPTION", UCHAR_LOGICAL_ORDER_EXCEPTION)
   else STRI_BINARYPROPERTY_CREATE("LOWERCASE", UCHAR_LOWERCASE)
   else STRI_BINARYPROPERTY_CREATE("MATH", UCHAR_MATH)
   else STRI_BINARYPROPERTY_CREATE("NONCHARACTER_CODE_POINT", UCHAR_NONCHARACTER_CODE_POINT)
   else STRI_BINARYPROPERTY_CREATE("QUOTATION_MARK", UCHAR_QUOTATION_MARK)
   else STRI_BINARYPROPERTY_CREATE("RADICAL", UCHAR_RADICAL)
   else STRI_BINARYPROPERTY_CREATE("SOFT_DOTTED", UCHAR_SOFT_DOTTED)
   else STRI_BINARYPROPERTY_CREATE("TERMINAL_PUNCTUATION", UCHAR_TERMINAL_PUNCTUATION)
   else STRI_BINARYPROPERTY_CREATE("UNIFIED_IDEOGRAPH", UCHAR_UNIFIED_IDEOGRAPH)
   else STRI_BINARYPROPERTY_CREATE("UPPERCASE", UCHAR_UPPERCASE)
   else STRI_BINARYPROPERTY_CREATE("WHITE_SPACE", UCHAR_WHITE_SPACE)
   else STRI_BINARYPROPERTY_CREATE("XID_CONTINUE", UCHAR_XID_CONTINUE)
   else STRI_BINARYPROPERTY_CREATE("XID_START", UCHAR_XID_START)
   else STRI_BINARYPROPERTY_CREATE("CASE_SENSITIVE", UCHAR_CASE_SENSITIVE)
   else STRI_BINARYPROPERTY_CREATE("S_TERM", UCHAR_S_TERM)
   else STRI_BINARYPROPERTY_CREATE("VARIATION_SELECTOR", UCHAR_VARIATION_SELECTOR)
   else STRI_BINARYPROPERTY_CREATE("NFD_INERT", UCHAR_NFD_INERT)
   else STRI_BINARYPROPERTY_CREATE("NFKD_INERT", UCHAR_NFKD_INERT)
   else STRI_BINARYPROPERTY_CREATE("NFC_INERT", UCHAR_NFC_INERT)
   else STRI_BINARYPROPERTY_CREATE("NFKC_INERT", UCHAR_NFKC_INERT)
   else STRI_BINARYPROPERTY_CREATE("SEGMENT_STARTER", UCHAR_SEGMENT_STARTER)
   else STRI_BINARYPROPERTY_CREATE("PATTERN_SYNTAX", UCHAR_PATTERN_SYNTAX)
   else STRI_BINARYPROPERTY_CREATE("PATTERN_WHITE_SPACE", UCHAR_PATTERN_WHITE_SPACE)
   else STRI_BINARYPROPERTY_CREATE("POSIX_ALNUM", UCHAR_POSIX_ALNUM)
   else STRI_BINARYPROPERTY_CREATE("POSIX_BLANK", UCHAR_POSIX_BLANK)
   else STRI_BINARYPROPERTY_CREATE("POSIX_GRAPH", UCHAR_POSIX_GRAPH)
   else STRI_BINARYPROPERTY_CREATE("POSIX_PRINT", UCHAR_POSIX_PRINT)
   else STRI_BINARYPROPERTY_CREATE("POSIX_XDIGIT", UCHAR_POSIX_XDIGIT)
   else STRI_BINARYPROPERTY_CREATE("CASED", UCHAR_CASED)
   else STRI_BINARYPROPERTY_CREATE("CASE_IGNORABLE", UCHAR_CASE_IGNORABLE)
   else STRI_BINARYPROPERTY_CREATE("CHANGES_WHEN_LOWERCASED", UCHAR_CHANGES_WHEN_LOWERCASED)
   else STRI_BINARYPROPERTY_CREATE("CHANGES_WHEN_UPPERCASED", UCHAR_CHANGES_WHEN_UPPERCASED)
   else STRI_BINARYPROPERTY_CREATE("CHANGES_WHEN_TITLECASED", UCHAR_CHANGES_WHEN_TITLECASED)
   else STRI_BINARYPROPERTY_CREATE("CHANGES_WHEN_CASEFOLDED", UCHAR_CHANGES_WHEN_CASEFOLDED)
   else STRI_BINARYPROPERTY_CREATE("CHANGES_WHEN_CASEMAPPED", UCHAR_CHANGES_WHEN_CASEMAPPED)
   else STRI_BINARYPROPERTY_CREATE("CHANGES_WHEN_NFKC_CASEFOLDED", UCHAR_CHANGES_WHEN_NFKC_CASEFOLDED)
...
#ifndef NDEBUG
   if (STRI__UCHAR_GET_BINPROP(STRI__UCHAR_CREATE_BINPROP(id)) != id)
      error("DEBUG: GET & CREATE test failed"); 
#endif

   id = STRI__UCHAR_CREATE_BINPROP(id);
#ifndef NDEBUG
   if (!STRI__UCHAR_IS_BINPROP(id)) error("DEBUG: !STRI__UCHAR_IS_BINPROP"); 
#endif   
   return ScalarInteger(id);
}
