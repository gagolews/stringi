...
expect_identical(stri_detect_fixed(c("", "ala", "ola"), "ala"), c(FALSE, TRUE,
    FALSE))
expect_identical(stri_detect(c("", "ala", "ola"), fixed = "ala", negate = TRUE),
    !c(FALSE, TRUE, FALSE))
expect_identical(stri_detect_fixed(c("ala", "", "", "bbb"), c("ala", "bbb")),
...
expect_identical(stri_detect_fixed(c("abc", "def", "123", "ghi", "456", "789",
