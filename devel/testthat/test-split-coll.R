...
test_that("stri_split_coll", {
   ...
   massa nibh nec erat."
    ...
    expect_identical(stri_split_coll("sss", "s", 1:3), list("sss", c("", "ss"), c("", 
        "", "s")))
    ...
    expect_identical(stri_split_coll("a_b_c__d", "_"), list(c("a", "b", "c", "", 
        "d")))
    expect_identical(stri_split_coll("a_b_c__d", "_", omit_empty = TRUE), list(c("a", 
        "b", "c", "d")))
    expect_identical(stri_split_coll("a_b_c__d", "_", n = 2, tokens_only = FALSE), 
        list(c("a", "b_c__d")))
    expect_identical(stri_split_coll("a_b_c__d", "_", n = 2, tokens_only = TRUE), 
        list(c("a", "b")))
    expect_identical(stri_split_coll("a_b_c__d", "_", n = 4, omit_empty = TRUE, tokens_only = TRUE), 
        list(c("a", "b", "c", "d")))
    expect_identical(stri_split_coll("a_b_c__d", "_", n = 4, omit_empty = FALSE, 
        tokens_only = TRUE), list(c("a", "b", "c", "")))
    expect_identical(stri_split_coll(c("ab_c", "d_ef_g", "h", ""), "_", n = 1, tokens_only = TRUE, 
        omit_empty = TRUE), list("ab", "d", "h", character(0)))
    expect_identical(stri_split_coll(c("ab_c", "d_ef_g", "h", ""), "_", n = 2, tokens_only = TRUE, 
        omit_empty = TRUE), list(c("ab", "c"), c("d", "ef"), "h", character(0)))
    expect_identical(stri_split_coll(c("ab_c", "d_ef_g", "h", ""), "_", n = 3, tokens_only = TRUE, 
