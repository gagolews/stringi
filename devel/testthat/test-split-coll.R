...
test_that("stri_split_coll", {
   ...
   expect_identical(stri_split_coll("gas","Z", n_max=0),list(character(0)))
   ...
   expect_identical(stri_split_coll("a_b_c__d", "_", n_max=2, tokens_only=FALSE), list(c("a", "b_c__d")))
   expect_identical(stri_split_coll("a_b_c__d", "_", n_max=2, tokens_only=TRUE), list(c("a", "b")))
   expect_identical(stri_split_coll("a_b_c__d", "_", n_max=4, omit_empty=TRUE, tokens_only=TRUE), list(c("a", "b", "c", "d")))
   expect_identical(stri_split_coll("a_b_c__d", "_", n_max=4, omit_empty=FALSE, tokens_only=TRUE), list(c("a", "b", "c", "")))
   expect_identical(stri_split_coll(c("ab_c", "d_ef_g", "h", ""), "_", n_max=1, tokens_only=TRUE, omit_empty=TRUE), list("ab", "d", "h", character(0)))
