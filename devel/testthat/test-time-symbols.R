...
test_that("stri_datetime_symbols", {
   ...
   expect_true(length(stri_datetime_symbols(locale="en_US", width="abbreviated")$Month) == 12)
   expect_true(length(stri_datetime_symbols(locale="en_US", width="abbreviated")$Weekday) == 7)
   expect_true(length(stri_datetime_symbols(locale="en_US", width="abbreviated")$Quarter) == 4)
