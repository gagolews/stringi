...
test_that("stri_trans_toupper", {
    ...
    expect_equivalent(stri_trans_toupper(c("!@#aAbBcC123", NA, "")), c("!@#AABBCC123", 
        NA, ""))
...
test_that("stri_trans_totitle", {
    ...
    expect_equivalent(stri_trans_totitle(c("!@#aAbBcC123", NA, "")), c("!@#Aabbcc123", 
        NA, ""))
