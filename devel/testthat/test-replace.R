...
test_that("stri_replace_all_fixed [byte]", {
   ...
   expect_identical(stri_replace_all_fixed("","\\p{Wspace}","?", opts_collator=NA),"")
...
test_that("stri_replace_first_fixed [byte]", {
   ...
   expect_identical(stri_replace_first_fixed("","\\p{Wspace}","?", opts_collator=NA),"")
...
test_that("stri_replace_last_fixed [byte]", {
   ...
   expect_identical(stri_replace_last_fixed("","\\p{Wspace}","?", opts_collator=NA),"")
