...
test_that("stri_locate_first_fixed", {
   ...
   expect_equivalent(stri_locate_first_fixed("aaaaaa", "aaaaaa"), matrix(c(1,6)))
   expect_equivalent(stri_locate_first_fixed("aaaaaa", "aaaaaaa"), matrix(c(NA_integer_,NA_integer_)))
   expect_equivalent(stri_locate_first_fixed("aaaaaa", "aaaaaaaa"), matrix(c(NA_integer_,NA_integer_)))
...
test_that("stri_locate_last_fixed", {
   ...
   expect_equivalent(stri_locate_last_fixed("aaaaaa", "aaaaaa"), matrix(c(1,6)))
   expect_equivalent(stri_locate_last_fixed("aaaaaa", "aaaaaaa"), matrix(c(NA_integer_,NA_integer_)))
   expect_equivalent(stri_locate_last_fixed("aaaaaa", "aaaaaaaa"), matrix(c(NA_integer_,NA_integer_)))
