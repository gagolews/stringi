...
A convenience function to tune the ICU regular expressions matcher's behavior, e.g., in `stri_count_regex <stri_count.html>`__ and other `stringi-search-regex <about_search_regex.html>`__ functions.
...
+------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ``literal``                  | logical; if set, treat the entire pattern as a literal string: metacharacters or escape sequences in the input sequence will be given no special meaning; note that in most cases you would rather use the `stringi-search-fixed <about_search_fixed.html>`__ facilities in this case |
+------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
Note that some regex settings may be changed using ICU regex flags inside regexes. For example, ``'(?i)pattern'`` performs a case-insensitive match of a given pattern, see the ICU User Guide entry on Regular Expressions in the References section or `stringi-search-regex <about_search_regex.html>`__.
...
Other search_regex: `about_search_regex <about_search_regex.html>`__, `about_search <about_search.html>`__
