...
## You are now working with stringi_1.7.4.9001 (pt_BR.UTF-8; ICU4C 69.1 [bundle]; Unicode 13.0)
...
## You are now working with stringi_1.7.4.9001 (en_AU.UTF-8; ICU4C 69.1 [bundle]; Unicode 13.0)
## End(Not run)
```
