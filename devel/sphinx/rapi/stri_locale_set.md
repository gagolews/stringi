...
## You are now working with stringi_1.6.2.9004 (pt_BR.UTF-8; ICU4C 69.1 [bundle]; Unicode 13.0)
...
## You are now working with stringi_1.6.2.9004 (en_AU.UTF-8; ICU4C 69.1 [bundle]; Unicode 13.0)
## End(Not run)
```
