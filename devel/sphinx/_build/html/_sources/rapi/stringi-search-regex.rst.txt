...
For information on how to define character classes in regexes, refer to `stringi-search-charclass <stringi-search-charclass.html>`__.
...
If you wish to search for a fixed pattern, refer to `stringi-search-coll <stringi-search-coll.html>`__ or `stringi-search-fixed <stringi-search-fixed.html>`__. They allow to perform a locale-aware text lookup, or a very fast exact-byte search, respectively.
