...
test_that("stri_locate_all_fixed", {
   ...
   expect_equivalent(stri_locate_all_fixed(stri_enc_nfkd("\u0105a"), "\u0105a", NA), list(matrix(c(NA,NA))))
...
test_that("stri_locate_last_fixed", {
   ...
   expect_equivalent(stri_locate_last_fixed(NA, "", NA), matrix(c(NA_integer_,NA_integer_)))
