...
test_that("stri_split", {
   ...
   expect_identical(stri_split("NA",NA),list(NA_character_))
   expect_identical(stri_split("NA","a",NA),list(NA_character_))
   expect_identical(stri_split("NA","a",1,NA),list(NA_character_))
   expect_identical(stri_split(" "," "),list(rep("",2)))
   expect_identical(stri_split("aa","a"),list(rep("",3)))
   expect_identical(stri_split("aa","a",Inf,TRUE),list(character(0)))
   ...
   expect_identical(stri_split("lalal","l",c(-Inf,-1,0)),
