...
test_that("stri_prepare_arg_raw", {
   
   expect_equivalent(stringi:::stri_prepare_arg_raw(0:3), as.raw(0:3))
   expect_equivalent(stringi:::stri_prepare_arg_raw(c(T,F,T,F)), as.raw(c(T,F,T,F)))
