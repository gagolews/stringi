...
## You are now working with stringi_1.7.0.9.9007 (pt_BR.UTF-8; ICU4C 69.1 [bundle]; Unicode 13.0)
...
## You are now working with stringi_1.7.0.9.9007 (en_AU.UTF-8; ICU4C 69.1 [bundle]; Unicode 13.0)
## End(Not run)
```
