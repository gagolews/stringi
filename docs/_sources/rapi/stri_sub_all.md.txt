...
For extracting/replacing single substrings from/within each string, see [`stri_sub`](https://stringi.gagolewski.com/rapi/stri_sub.html).
...
Vectorized over `str`, \[`value`\], `from` and (`to` or `length`). Just like in [`stri_sub`](https://stringi.gagolewski.com/rapi/stri_sub.html), parameters `to` and `length` are mutually exclusive.
...
`from` can be a list of two-column matrices. In such a case, the two columns play a role of `from` and `to`, respectively. Such types of index matrices are generated by [`stri_locate_all`](https://stringi.gagolewski.com/rapi/stri_locate_all.html). If extraction or replacement based on [`stri_locate_first`](https://stringi.gagolewski.com/rapi/stri_locate_first.html) or [`stri_locate_last`](https://stringi.gagolewski.com/rapi/stri_locate_last.html) is needed, see [`stri_sub`](https://stringi.gagolewski.com/rapi/stri_sub.html).
...
Other indexing: [`stri_locate_all_boundaries`](https://stringi.gagolewski.com/rapi/stri_locate_all_boundaries.html)(), [`stri_locate_all`](https://stringi.gagolewski.com/rapi/stri_locate_all.html)(), [`stri_sub`](https://stringi.gagolewski.com/rapi/stri_sub.html)()
