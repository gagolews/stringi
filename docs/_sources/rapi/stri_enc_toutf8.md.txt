...
If the default encoding is UTF-8, see [`stri_enc_get`](stri_enc_set.md), then strings marked with `native` are -- for efficiency reasons -- returned as-is, i.e., with unchanged markings. A similar behavior is observed when calling [`enc2utf8`](https://stat.ethz.ch/R-manual/R-patched/library/base/html/Encoding.html).
...
Other encoding\_conversion: [`about_encoding`](about_encoding.md), [`stri_enc_fromutf32()`,](stri_enc_fromutf32.md) [`stri_enc_toascii()`,](stri_enc_toascii.md) [`stri_enc_tonative()`,](stri_enc_tonative.md) [`stri_enc_toutf32()`,](stri_enc_toutf32.md) `stri_encode()`
