...
``stri_enc_set`` sets the encoding used to re-encode strings internally (i.e., by R) declared to be in native encoding, see `stringi-encoding <stringi-encoding.html>`__ and `stri_enc_mark <stri_enc_mark.html>`__. ``stri_enc_get`` returns the currently used default encoding.
...
If you set a default encoding that is neither a superset of ASCII, nor an 8-bit encoding, a warning will be generated, see `stringi-encoding <stringi-encoding.html>`__ for discussion.
...
Other encoding_management: `stri_enc_info() <stri_enc_info.html>`__, `stri_enc_list() <stri_enc_list.html>`__, `stri_enc_mark() <stri_enc_mark.html>`__, `stringi-encoding <stringi-encoding.html>`__
